...
ggplot(filter(obesidad_transp, family_history_with_overweight == "yes"), aes(y = NObeyesdad, fill = NObeyesdad)) +
...
ggplot(filter(obesidad_transp, family_history_with_overweight == "no"), aes(y = NObeyesdad, fill = NObeyesdad)) +
  geom_bar(position = "dodge") +  # Barras separadas
  labs(y = "Nivel de Obesidad", x = "Frecuencia", fill = "NObesity") +
...
Vamos a hacer la matriz de distacia de gower ya que tenemos variables de tipo caracter y de tipo numérico.para estos datos, vamos a cambiar las variables que son de tipo cadena de caracteres a factores.
